...
fields = ["TR.CommonName", "TR.TickerSymbol","TR.HeadquartersCountry","TR.CreditComboImpliedRating",
          "TR.F.ReturnCapEmployedPct(SDate=0CY,Period=FY1)",
...
fields0 = ["TR.CommonName", "TR.TickerSymbol","TR.HeadquartersCountry","TR.CreditComboImpliedRating","TR.F.ReturnCapEmployedPct(SDate=0CY,Period=FY0)",
           "TR.F.NetPPEPctofTotAssets(SDate=0CY,Period=FY0)",
    ...
    , "TR.F.NetDebttoTotEq(SDate=0CY,Period=FY0)",
          ...
          "TR.F.TotLiabEq(SDate=0CY,Period=FY0)",
           ...
           "TR.F.CAPEXTot(SDate=0CY,Period=FY0)"]
...
for x in range(0, 30):
    ...
    fields2 = ["TR.CommonName","TR.TickerSymbol","TR.HeadquartersCountry",
               "TR.CreditComboImpliedRating"
               ,"TR.F.ReturnCapEmployedPct(SDate=0CY,Period=FY-"+i+")",
               "TR.F.NetPPEPctofTotAssets(SDate=0CY,Period=FY-"+i+")"
...
print(df)
df.to_csv("dfInt.csv",index=False)
